											...
											{#each courses as course}
												<div class="shadow-md rounded-md p-4 inline-flex items-center gap-x-4">
													<input
														...
														value={course.key}
														checked={programme?.outline?.['year1']?.['sem1']?.includes(course.key)}
													/>
											...
											{#each courses as course}
												<div class="shadow-md rounded-md p-4 inline-flex items-center gap-x-4">
													<input
														...
														class="checkbox checkbox-primary checkbox-sm"
														value={course.key}
														checked={programme?.outline?.['year1']?.['sem2']?.includes(course.key)}
													/>
													<p class="text-sm font-medium">
														{course.title}
													</p>
											...
											{#each courses as course}
												<div class="shadow-md rounded-md p-4 inline-flex items-center gap-x-4">
													<input
														...
														class="checkbox checkbox-primary checkbox-sm"
														value={course.key}
														checked={programme?.outline?.['year2']?.['sem1']?.includes(course.key)}
													/>
													<p class="text-sm font-medium">
														{course.title}
													</p>
											...
											{#each courses as course}
												<div class="shadow-md rounded-md p-4 inline-flex items-center gap-x-4">
													<input
														...
														class="checkbox checkbox-primary checkbox-sm"
														value={course.key}
														checked={programme?.outline?.['year2']?.['sem2']?.includes(course.key)}
													/>
													<p class="text-sm font-medium">
														{course.title}
													</p>
											...
											{#each courses as course}
												<div class="shadow-md rounded-md p-4 inline-flex items-center gap-x-4">
													<input
														...
														class="checkbox checkbox-primary checkbox-sm"
														value={course.key}
														checked={programme?.outline?.['year3']?.['sem1']?.includes(course.key)}
													/>
													<p class="text-sm font-medium">
														{course.title}
													</p>
											...
											{#each courses as course}
												<div class="shadow-md rounded-md p-4 inline-flex items-center gap-x-4">
													<input
														...
														class="checkbox checkbox-primary checkbox-sm"
														value={course.key}
														checked={programme?.outline?.['year3']?.['sem2']?.includes(course.key)}
													/>
													<p class="text-sm font-medium">
														{course.title}
													</p>
											...
											{#each courses as course}
												<div class="shadow-md rounded-md p-4 inline-flex items-center gap-x-4">
													<input
														...
														class="checkbox checkbox-primary checkbox-sm"
														value={course.key}
														checked={programme?.outline?.['year4']?.['sem1']?.includes(course.key)}
													/>
													<p class="text-sm font-medium">
														{course.title}
													</p>
											...
											{#each courses as course}
												<div class="shadow-md rounded-md p-4 inline-flex items-center gap-x-4">
													<input
														...
														class="checkbox checkbox-primary checkbox-sm"
														value={course.key}
														checked={programme?.outline?.['year4']?.['sem2']?.includes(course.key)}
													/>
													<p class="text-sm font-medium">
														{course.title}
													</p>
